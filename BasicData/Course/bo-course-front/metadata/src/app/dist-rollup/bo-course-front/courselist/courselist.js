/*! UPDATE TIME: 2024/11/11 01:29:26 */
    ...
    return {
        ...
        execute: function () {
            ...
            function createTranslateLoader(http, version) {
                ...
                return new TranslateHttpLoader(http, BasePathService.convertPath('/apps/studentsystem/basicdata/web/bo-course-front/courselist/i18n/'), '.json' + versionSuffix);
            }
            var lang = { "zh-CHS": { "root-component": "", "root-layout": "", "query-scheme-section": "", "Section/query-scheme-section/mainTitle": "主标题", "Section/query-scheme-section/subTitle": "", "query-scheme-1": "默认筛选方案", "QueryScheme/query-scheme-1/filterText": "筛选", "QueryScheme/query-scheme-1/1b390991-8c11-448c-a3d9-4f693f4290a7": "课程编号", "QueryScheme/query-scheme-1/1b390991-8c11-448c-a3d9-4f693f4290a7/placeHolder": "", "QueryScheme/query-scheme-1/40c471b0-f364-4c98-926e-dd499f67470a": "课程名称", "QueryScheme/query-scheme-1/40c471b0-f364-4c98-926e-dd499f67470a/placeHolder": "", "QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57": "课程类型", "QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/placeHolder": "", "QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/control/enumValues/basic": "基础课", "QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/control/enumValues/central": "核心课", "QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/control/enumValues/selected": "选修课", "page-header": "", "header-nav": "", "header-title-container": "", "page-header-title": "", "title": "课程列表", "page-header-toolbar": "", "button-add": "新增", "button-edit": "编辑", "button-view": "查看", "button-delete": "删除", "page-main": "", "data-grid-component-ref": "", "data-grid-component": "", "data-grid-section": "", "Section/data-grid-section/mainTitle": "", "Section/data-grid-section/subTitle": "", "dataGrid": "", "DataGrid/dataGrid/lineNumberTitle": "", "DataGrid/dataGrid/OperateEditButton": "编辑", "DataGrid/dataGrid/OperateDeleteButton": "删除", "DataGrid/dataGrid/OperateColumn": "操作", "cid_1b390991_vcw5": "课程编号", "name_40c471b0_k303": "课程名称", "sort_cf562a4b_vch3": "课程类型", "GridField/sort_cf562a4b_vch3/enumData/basic": "基础课", "GridField/sort_cf562a4b_vch3/enumData/central": "核心课", "GridField/sort_cf562a4b_vch3/enumData/selected": "选修课", "hour_9b190013_bya0": "学时", "teacher_b6068cf6_yrx0": "授课教师" } };
            ...
            var RootViewmodel = /** @class */ (function (_super) {
                ...
                __decorate([
                    NgCommand({
                        name: 'Add1',
                        params: {
                            url: '785fdb66-1f1d-4e6d-b98a-e78b58dda1c6',
            ...
            var CourseProxy = /** @class */ (function (_super) {
                ...
                function CourseProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/studentsystem/basicdata/v1.0/courselist_frm';
            ...
            var CourseRepository = /** @class */ (function (_super) {
                ...
                CourseRepository = __decorate([
                    Injectable(),
                    NgRepository({
                        apiUrl: 'api/studentsystem/basicdata/v1.0/courselist_frm',
                    ...
                    _this.fieldConfigsqueryscheme1 = [
                        {
                            ...
                            "labelCode": "CID",
                            "code": "CID",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/1b390991-8c11-448c-a3d9-4f693f4290a7", _this.lang, "课程编号"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/1b390991-8c11-448c-a3d9-4f693f4290a7/placeHolder", _this.lang, ""),
                            "control": { "id": "1b390991-8c11-448c-a3d9-4f693f4290a7", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "40c471b0-f364-4c98-926e-dd499f67470a",
                            "labelCode": "Name",
                            "code": "Name",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/40c471b0-f364-4c98-926e-dd499f67470a", _this.lang, "课程名称"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/40c471b0-f364-4c98-926e-dd499f67470a/placeHolder", _this.lang, ""),
                            "control": { "id": "40c471b0-f364-4c98-926e-dd499f67470a", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "cf562a4b-5055-4bea-a096-548fa3e74b57",
                            "labelCode": "Sort",
                            "code": "Sort",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57", _this.lang, "课程类型"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/placeHolder", _this.lang, ""),
                            "control": {
                                ...
                                "enumValues": [
                                    {
                                        "value": "basic",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/control/enumValues/basic", _this.lang, "基础课")
                                    },
                                    {
                                        "value": "central",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/control/enumValues/central", _this.lang, "核心课")
                                    },
                                    {
                                        "value": "selected",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/cf562a4b-5055-4bea-a096-548fa3e74b57/control/enumValues/selected", _this.lang, "选修课")
                                    }
                                ]
                            }
                        }
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "965bd937-773b-4231-b5e6-ecd23448a3a6" },
                ...
                CourseListModule = __decorate([
                    NgModule({
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/studentsystem/basicdata/web/bo-course-front/courselist/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/studentsystem/basicdata/web/bo-course-front/courselist/i18n/', '.json');
            }
            ...
            function View_RootComponent_3(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 5, "farris-querysolution", [["farris-querysolution-event-bind", ""], ["id", "query-scheme-1"]], [[8, "className", 0]], [[null, "queryEmitter"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("queryEmitter" === en)) {
                    ...
                    ad = (pd_1 && ad);
                } return ad; }, View_QuerySolutionComponent_0, RenderType_QuerySolutionComponent)), ɵprd(512, null, ConvertorService, ConvertorService, []), ɵprd(512, null, ɵa$1, ɵa$1, [HttpClient]), ɵprd(512, null, ɵb$2, ɵb$2, []), ɵdid(4, 770048, null, 0, QuerySolutionComponent, [NotifyService, ComponentFactoryResolver, Injector, BsModalService, ConvertorService, SolutionService, ɵa$1, ɵb$2, LocaleService], { fieldConfigs: [0, "fieldConfigs"], presetQuerySolutionName: [1, "presetQuerySolutionName"], presetFieldConfigs: [2, "presetFieldConfigs"], isDisabled: [3, "isDisabled"], formId: [4, "formId"], isFold: [5, "isFold"], isControlInline: [6, "isControlInline"], showCompleteLabel: [7, "showCompleteLabel"], enableInitQuery: [8, "enableInitQuery"], enableHistory: [9, "enableHistory"], filterText: [10, "filterText"] }, { queryEmitter: "queryEmitter" }), ɵdid(5, 16384, null, 0, FarrisQuerySolutionEventBindDirective, [Injector, QuerySolutionComponent, FrameContext], null, null)], function (_ck, _v) { var _co = _v.component; var currVal_1 = _co.fieldConfigsqueryscheme1; var currVal_2 = _co.QuerySolutionqueryscheme1; var currVal_3 = _co.presetFieldConfigsqueryscheme1; var currVal_4 = false; var currVal_5 = "CourseList"; var currVal_6 = !true; var currVal_7 = true; var currVal_8 = false; var currVal_9 = false; var currVal_10 = false; var currVal_11 = _co.filterTextqueryscheme1; _ck(_v, 4, 1, [currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10, currVal_11]); }, function (_ck, _v) { var currVal_0 = ɵnov(_v, 4).cls; _ck(_v, 0, 0, currVal_0); }); }
