        ...
        execute: function () {
            ...
            var TranslateResolveService = /** @class */ (function () {
                ...
                TranslateResolveService.prototype.resolve = function (route, state) {
                    ...
                    if (langCode == "zh-CHS" || (this.translate.defaultLang === langCode && this.translate.currentLoader == createTranslateLoader(this.http, null))) {
                        ...
                        var httpOb = this.http.get(BasePathService.getBasePath() + "/apps/studentsystem/basicdata/web/bo-course-front/version.json?v=" + new Date().getTime()).pipe(switchMap(function (data) {
                            var currentVersion = null;
                            if (data instanceof Array) {
                                var versionKey_1 = "coursedetail/" + langCode + ".json";
            ...
            var CourseProxy = /** @class */ (function (_super) {
                ...
                function CourseProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/studentsystem/basicdata/v1.0/coursedetail_frm';
            ...
            var CourseRepository = /** @class */ (function (_super) {
                ...
                CourseRepository = __decorate([
                    Injectable(),
                    NgRepository({
                        apiUrl: 'api/studentsystem/basicdata/v1.0/coursedetail_frm',
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "4cd0c31e-ddf9-4f41-881c-1961f9d7448f" },
            ...
            var CourseDetailRoutingModule = /** @class */ (function () {
                function CourseDetailRoutingModule() {
                }
                CourseDetailRoutingModule = __decorate([
                    NgModule({
                        imports: [
                ...
                return CourseDetailRoutingModule;
            }());
            ...
            var BasicFormComponent = /** @class */ (function (_super) {
                ...
                function BasicFormComponent(wizardSer, keybindingService, langService, route, router, rootElement, localizationService, frmI18nSettingService, focusInvalidService, componentManagerService, sanitizer, injector) {
                    ...
                    _this.LookupEditteacherbab461b2av4rDialogTitle = _this.langService.transform("LookupEdit/teacher_bab461b2_av4r/dialogTitle", _this.lang, "");
                    _this.teacher_bab461b2_av4r_PlaceHolder = _this.langService.transform("LookupEdit/teacher_bab461b2_av4r/placeHolder", _this.lang, "");
                    _this.teacher_bab461b2_av4rQuickSelect = {
                        "enable": false,
                        "showItemsCount": 10,
                        "showMore": true
                    };
                    _this.hour_3bbe082f_6ngd_PlaceHolder = _this.langService.transform("NumericBox/hour_3bbe082f_6ngd/placeHolder", _this.lang, "");
                    _this.hour3bbe082f6ngdTextOptions = {
                        "type": "number",
                        "useThousands": true,
                        "precision": 0,
                    };
                    _this.sort_152aa80b_68woEnumData = [
                        {
                            "name": _this.langService.transform("EnumField/sort_152aa80b_68wo/enumData/basic", _this.lang, "基础课"),
                            "value": "basic",
                            "disabled": false
                        },
                        {
                            "name": _this.langService.transform("EnumField/sort_152aa80b_68wo/enumData/central", _this.lang, "核心课"),
                            "value": "central",
                            "disabled": false
                        },
                        {
                            "name": _this.langService.transform("EnumField/sort_152aa80b_68wo/enumData/selected", _this.lang, "选修课"),
                            "value": "selected",
                            "disabled": false
                        }
                    ];
                    _this.sort_152aa80b_68wo_PlaceHolder = _this.langService.transform("EnumField/sort_152aa80b_68wo/placeHolder", _this.lang, "");
                    _this.cid_3ef59c5b_7twz_PlaceHolder = _this.langService.transform("TextBox/cid_3ef59c5b_7twz/placeHolder", _this.lang, "");
                    _this.name_1afade1f_8y0g_PlaceHolder = _this.langService.transform("TextBox/name_1afade1f_8y0g/placeHolder", _this.lang, "");
                    _this.lang = localStorage.getItem('languageCode') || "zh-CHS";
                ...
                ], BasicFormComponent.prototype, "teacher_bab461b2_av4r", void 0);
                __decorate([
                    HostBinding('class'),
                    __metadata("design:type", Object)
            ...
            var CourseDetailModule = /** @class */ (function () {
                function CourseDetailModule(trans) {
                    this.trans = trans;
                }
                CourseDetailModule = __decorate([
                    NgModule({
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/studentsystem/basicdata/web/bo-course-front/coursedetail/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/studentsystem/basicdata/web/bo-course-front/coursedetail/i18n/', '.json');
            }
            ...
            function View_BasicFormComponent_5(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 10, "input", [["class", "form-control"], ["formControlName", "cid"], ["id", "cid_3ef59c5b_7twz"], ["input-end-edit", ""], ["maxlength", "36"], ["tabindex", "-1"]], [[8, "readOnly", 0], [8, "placeholder", 0], [1, "maxlength", 0], [2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) { var ad = true; if (("input" === en)) {
            ...
            function View_BasicFormComponent_9(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 10, "input", [["class", "form-control"], ["formControlName", "name"], ["id", "name_1afade1f_8y0g"], ["input-end-edit", ""], ["maxlength", "36"], ["tabindex", "-1"]], [[8, "readOnly", 0], [8, "placeholder", 0], [1, "maxlength", 0], [2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) { var ad = true; if (("input" === en)) {
                    var pd_0 = (ɵnov(_v, 1)._handleInput($event.target.value) !== false);
                    ad = (pd_0 && ad);
                } if (("blur" === en)) {
                    var pd_1 = (ɵnov(_v, 1).onTouched() !== false);
