...
System.register(['@angular/core', 'tslib', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/router', '@angular/common/http', '@ecp-caf/caf-common', '@gsp-sys/rtf-common', '@angular/common', 'rxjs/operators', 'rxjs', '@farris/rtf', '@angular/platform-browser-dynamic', '@angular/animations/browser', '@angular/animations'], function (exports, module) {
    ...
    return {
        ...
        execute: function () {
            ...
            var routes = [
                { path: 'CourseDetail', loadChildren: './coursedetail/coursedetail#CourseDetailModule' },
            ...
            var SystemjsLcModuleloaderGenerator = /** @class */ (function () {
                ...
                SystemjsLcModuleloaderGenerator.prototype.loadFactory = function (path) {
                    ...
                    var projectPath = "/apps/studentsystem/basicdata/web/bo-course-front/";
