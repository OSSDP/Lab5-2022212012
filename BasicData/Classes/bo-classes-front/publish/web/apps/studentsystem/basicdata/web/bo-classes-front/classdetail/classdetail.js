/*! UPDATE TIME: 2024/11/11 01:43:37 */
    ...
    return {
        ...
        execute: function () {
            ...
            var TranslateResolveService = /** @class */ (function () {
                ...
                TranslateResolveService.prototype.resolve = function (route, state) {
                    ...
                    if (langCode == "zh-CHS" || (this.translate.defaultLang === langCode && this.translate.currentLoader == createTranslateLoader(this.http, null))) {
                        ...
                        var httpOb = this.http.get(BasePathService.getBasePath() + "/apps/studentsystem/basicdata/web/bo-classes-front/version.json?v=" + new Date().getTime()).pipe(switchMap(function (data) {
                            var currentVersion = null;
                            if (data instanceof Array) {
                                var versionKey_1 = "classdetail/" + langCode + ".json";
            ...
            var RootViewmodel = /** @class */ (function (_super) {
                ...
                function RootViewmodel() {
                    ...
                    _this.childViewModels = {
                        ...
                        'StudentComponentViewmodel': 'studentComponentViewmodel'
                    };
                    return _this;
                }
            ...
            var StudentA0cAEntity = /** @class */ (function (_super) {
                __extends(StudentA0cAEntity, _super);
            ...
            var StudentEntity = /** @class */ (function (_super) {
                ...
                __decorate([
                    ...
                    __metadata("design:type", StudentA0cAEntity)
            ...
            var ClassesProxy = /** @class */ (function (_super) {
                ...
                function ClassesProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/studentsystem/basicdata/v1.0/classdetail_frm';
            ...
            var ClassesRepository = /** @class */ (function (_super) {
                ...
                ClassesRepository = __decorate([
                    Injectable(),
                    NgRepository({
                        apiUrl: 'api/studentsystem/basicdata/v1.0/classdetail_frm',
            ...
            var RootComponent = /** @class */ (function (_super) {
                ...
                function RootComponent(wizardSer, keybindingService, langService, route, router, rootElement, localizationService, frmI18nSettingService, frameworkService, applicationParamsService, verifyService, stateMachine, sanitizer, injector) {
                        ...
                        contents: [
                            {
                                ...
                                visible: true,
                                title: _this.langService.transform("studentAddButton", _this.lang, "新增"),
                                click: function () { _this.viewModel.studentComponentViewmodel.studentAddItem1(); },
                                split: false,
                                isDP: false,
                                children: [],
                                appearance: {
                            ...
                            },
                            {
                                ...
                                visible: true,
                                title: _this.langService.transform("studentRemoveButton", _this.lang, "删除"),
                                click: function () { _this.viewModel.studentComponentViewmodel.studentRemoveItem1(); },
                                split: false,
                                isDP: false,
                                children: [],
                                appearance: {
                    ...
                    _this.studenttabpage = _this.langService.transform("student-tab-page", _this.lang, "学生");
                ...
                RootComponent.prototype.ngOnInit = function () {
                    ...
                    this.stateMachine.stateChange.subscribe(function () {
                        var states = {
                            'studentAddButton': !_this.viewModel.stateMachine['canAddDetail'],
                            'studentRemoveButton': !_this.viewModel.stateMachine['canRemoveDetail'],
                        };
                        _this.tabsToolbarStates.next(states);
                    });
                    this.stateMachine.stateChange.subscribe(function () {
                        var visibleStates = {
                            'studentAddButton': true,
                            'studentRemoveButton': true,
                        };
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "f9a5f1ff-f160-4d56-81bc-bc7aa4117981" },
            ...
            var ClassDetailRoutingModule = /** @class */ (function () {
                ...
                ClassDetailRoutingModule = __decorate([
                    NgModule({
                        imports: [
            ...
            var BasicFormComponent = /** @class */ (function (_super) {
                ...
                function BasicFormComponent(wizardSer, keybindingService, langService, route, router, rootElement, localizationService, frmI18nSettingService, focusInvalidService, componentManagerService, sanitizer, injector) {
                    ...
                    _this.LookupEditclassTcher57706799m5dzDialogTitle = _this.langService.transform("LookupEdit/classTcher_57706799_m5dz/dialogTitle", _this.lang, "");
                    _this.classTcher_57706799_m5dz_PlaceHolder = _this.langService.transform("LookupEdit/classTcher_57706799_m5dz/placeHolder", _this.lang, "");
                    _this.classTcher_57706799_m5dzQuickSelect = {
                        "enable": false,
                        "showItemsCount": 10,
                        "showMore": true
                    };
                    _this.name_97531977_j5o1_PlaceHolder = _this.langService.transform("TextBox/name_97531977_j5o1/placeHolder", _this.lang, "");
                    _this.lang = localStorage.getItem('languageCode') || "zh-CHS";
                ...
                BasicFormComponent.prototype.ngAfterViewInit = function () {
                    this.componentManagerService.appendControl('classTcher_57706799_m5dz', this.classTcher_57706799_m5dz);
                };
                ...
                __decorate([
                    ViewChild('classTcher_57706799_m5dz'),
                    __metadata("design:type", LookupGridComponent)
                ], BasicFormComponent.prototype, "classTcher_57706799_m5dz", void 0);
                __decorate([
                    HostBinding('class'),
                    __metadata("design:type", Object)
            ...
            var StudentComponentViewmodel = /** @class */ (function (_super) {
                __extends(StudentComponentViewmodel, _super);
                ...
                StudentComponentViewmodel = __decorate([
                    Injectable()
            ...
            var StudentComponentViewmodelForm = /** @class */ (function (_super) {
                __extends(StudentComponentViewmodelForm, _super);
                ...
                StudentComponentViewmodelForm = __decorate([
                    Injectable(),
                    NgValidateForm({
                        formGroupName: '学生',
                        enableValidate: true
            ...
            var StudentComponentViewmodelUIState = /** @class */ (function (_super) {
                __extends(StudentComponentViewmodelUIState, _super);
                function StudentComponentViewmodelUIState() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                StudentComponentViewmodelUIState = __decorate([
                    Injectable()
            ...
            var studentAddItem1Handler = /** @class */ (function (_super) {
                __extends(studentAddItem1Handler, _super);
                ...
                studentAddItem1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
            ...
            var studentRemoveItem1Handler = /** @class */ (function (_super) {
                __extends(studentRemoveItem1Handler, _super);
                function studentRemoveItem1Handler(_DataGridService1, _SubListDataService1, _ListDataService1) {
                    var _this = _super.call(this) || this;
                ...
                studentRemoveItem1Handler.prototype.schedule = function () {
                    var _this = this;
                ...
                studentRemoveItem1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'studentRemoveItem1'
                    }),
                    __metadata("design:paramtypes", [DataGridService,
                        SubListDataService,
                        ListDataService])
                ], studentRemoveItem1Handler);
                return studentRemoveItem1Handler;
            }(CommandHandler));
            ...
            var ClassDetailModule = /** @class */ (function () {
                function ClassDetailModule(trans) {
                    this.trans = trans;
                }
                ClassDetailModule = __decorate([
                    NgModule({
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/studentsystem/basicdata/web/bo-classes-front/classdetail/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/studentsystem/basicdata/web/bo-classes-front/classdetail/i18n/', '.json');
            }
             ...
             * tslint:disable
             */ 
            var styles_StudentComponent = [styles$1];
            var RenderType_StudentComponent = ɵcrt({ encapsulation: 0, styles: styles_StudentComponent, data: {} });
            function View_StudentComponent_2(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 10, "farris-datagrid", [["class", "f-component-grid f-utils-fill"], ["datagridRef", ""], ["farris-grid-end-edit", ""], ["farris-remote-summary-command", ""], ["farris-use-binding-data", ""], ["id", "dataGrid_student"]], [[4, "position", null], [2, "f-datagrid-full", null], [2, "f-datagrid-auto-height", null]], [[null, "click"], [null, "pageChanged"], [null, "selectChanged"], [null, "unSelect"], [null, "checkedChange"], [null, "pageSizeChanged"], [null, "scrollYLoad"], [null, "filterChanged"]], function (_v, en, $event) { var ad = true; if (("click" === en)) {
            ...
            function View_BasicFormComponent_5(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 10, "input", [["class", "form-control"], ["formControlName", "name"], ["id", "name_97531977_j5o1"], ["input-end-edit", ""], ["maxlength", "36"], ["tabindex", "-1"]], [[8, "readOnly", 0], [8, "placeholder", 0], [1, "maxlength", 0], [2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) { var ad = true; if (("input" === en)) {
            ...
            function View_BasicFormComponent_0(_l) { return ɵvid(0, [ɵpid(0, LangPipe, [TranslateService, HttpClient]), ɵqud(671088640, 1, { classTcher_57706799_m5dz: 0 }), (_l()(), ɵand(16777216, null, null, 1, null, View_BasicFormComponent_1)), ɵdid(3, 16384, null, 0, NgIf, [ViewContainerRef, TemplateRef], { ngIf: [0, "ngIf"] }, null)], function (_ck, _v) { var currVal_0 = true; _ck(_v, 3, 0, currVal_0); }, null); }
