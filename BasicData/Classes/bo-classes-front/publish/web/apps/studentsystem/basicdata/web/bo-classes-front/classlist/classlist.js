    ...
    return {
        ...
        execute: function () {
            ...
            function createTranslateLoader(http, version) {
                ...
                return new TranslateHttpLoader(http, BasePathService.convertPath('/apps/studentsystem/basicdata/web/bo-classes-front/classlist/i18n/'), '.json' + versionSuffix);
            }
            var lang = { "zh-CHS": { "root-component": "", "root-layout": "", "page-header": "", "header-nav": "", "header-title-container": "", "page-header-title": "", "title": "班级列表", "page-header-toolbar": "", "button-add": "新增", "button-edit": "编辑", "button-view": "查看", "button-delete": "删除", "page-main": "", "data-grid-component-ref": "", "data-grid-component": "", "data-grid-section": "", "Section/data-grid-section/mainTitle": "", "Section/data-grid-section/subTitle": "", "dataGrid": "", "DataGrid/dataGrid/lineNumberTitle": "", "DataGrid/dataGrid/OperateEditButton": "编辑", "DataGrid/dataGrid/OperateDeleteButton": "删除", "DataGrid/dataGrid/OperateColumn": "操作", "name_afd5e005_l32s": "班级名称", "classTcher_06fe7f39_20ep": "班主任" } };
                    ...
                    if (langCode == "zh-CHS" || (this.translate.defaultLang === langCode && this.translate.currentLoader == createTranslateLoader(this.http, null))) {
                        ...
                        var httpOb = this.http.get(BasePathService.getBasePath() + "/apps/studentsystem/basicdata/web/bo-classes-front/version.json?v=" + new Date().getTime()).pipe(switchMap(function (data) {
                            ...
                            if (data instanceof Array) {
                                var versionKey_1 = "classlist/" + langCode + ".json";
            ...
            var RootViewmodel = /** @class */ (function (_super) {
                ...
                __decorate([
                    NgCommand({
                        name: 'Add1',
                        params: {
                            url: 'b91ad9bf-660e-4927-bd08-fd75be1631c4',
            ...
            var ClassesProxy = /** @class */ (function (_super) {
                ...
                function ClassesProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/studentsystem/basicdata/v1.0/classlist_frm';
            ...
            var ClassesRepository = /** @class */ (function (_super) {
                ...
                ClassesRepository = __decorate([
                    Injectable(),
                    NgRepository({
                        apiUrl: 'api/studentsystem/basicdata/v1.0/classlist_frm',
            ...
            var Search1Handler = /** @class */ (function (_super) {
                ...
                function Search1Handler(_FilterService1, _ListDataService1) {
                    var _this = _super.call(this) || this;
            ...
            var View1Handler = /** @class */ (function (_super) {
                ...
                function View1Handler(_DataCheckService1, _NavigationMiddlewareService1, _NavigationService1) {
                    var _this = _super.call(this) || this;
                ...
                View1Handler = __decorate([
                    ...
                    __metadata("design:paramtypes", [DataCheckService,
            ...
            var Edit1Handler = /** @class */ (function (_super) {
                ...
                function Edit1Handler(_DataCheckService1, _NavigationMiddlewareService1, _NavigationService1) {
                    var _this = _super.call(this) || this;
                    _this._DataCheckService1 = _DataCheckService1;
                    _this._NavigationMiddlewareService1 = _NavigationMiddlewareService1;
                    _this._NavigationService1 = _NavigationService1;
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "8ec553e5-a6e2-4042-99db-7e3d2e6dfdf5" },
            ...
            var ClassListRoutingModule = /** @class */ (function () {
                ...
                ClassListRoutingModule = __decorate([
                    NgModule({
                        imports: [
                    ...
                    _this.dom = {
                        "dataGrid": {
                            ...
                            "fields": [
                                ...
                                {
                                    "type": "GridField",
                                    "resourceId": "classTcher_06fe7f39_20ep",
                                    "visible": {
                                        "useQuote": false,
                                        "isExpression": false,
                                        "value": true
                        ...
                        [
                            {
                                ...
                                field: 'name',
                                width: 120,
                                title: this.langService.transform("name_afd5e005_l32s", this.lang, "班级名称"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'classTcher',
                                width: 120,
                                title: this.langService.transform("classTcher_06fe7f39_20ep", this.lang, "班主任"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
            ...
            var ClassListModule = /** @class */ (function () {
                function ClassListModule(trans) {
                    this.trans = trans;
                }
                ClassListModule = __decorate([
                    NgModule({
                        exports: [
                            RootComponent
                        ],
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/studentsystem/basicdata/web/bo-classes-front/classlist/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/studentsystem/basicdata/web/bo-classes-front/classlist/i18n/', '.json');
            }
