...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.stateMachine.stateChange.subscribe(() => {
            const states = {
                'studentAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'studentRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
            }
        ...
        contents: [
    {
        ...
        visible: true,
        title: this.langService.transform("studentAddButton", this.lang, "新增"),
        click: () => { this.viewModel.studentComponentViewmodel.studentAddItem1(); },
        split: false,
        isDP: false,
        children: [],
        appearance: {
...
},
    {
        ...
        visible: true,
        title: this.langService.transform("studentRemoveButton", this.lang, "删除"),
        click: () => { this.viewModel.studentComponentViewmodel.studentRemoveItem1(); },
        split: false,
        isDP: false,
        children: [],
        appearance: {
    ...
    studenttabpage = this.langService.transform("student-tab-page", this.lang, "学生");
