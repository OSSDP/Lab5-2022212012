...
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    classTcher_57706799_m5dz: LookupGridComponent;
    ...
    LookupEditclassTcher57706799m5dzDialogTitle = this.langService.transform("LookupEdit/classTcher_57706799_m5dz/dialogTitle", this.lang, "");
    classTcher_57706799_m5dz_PlaceHolder = this.langService.transform("LookupEdit/classTcher_57706799_m5dz/placeHolder", this.lang, "");
    classTcher_57706799_m5dzQuickSelect = {
        "enable": false,
        "showItemsCount": 10,
        "showMore": true
    }
    name_97531977_j5o1_PlaceHolder = this.langService.transform("TextBox/name_97531977_j5o1/placeHolder", this.lang, "");
}