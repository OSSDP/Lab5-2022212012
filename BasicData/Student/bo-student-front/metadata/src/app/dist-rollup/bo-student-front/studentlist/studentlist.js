/*! UPDATE TIME: 2024/11/9 21:56:03 */
    ...
    return {
        ...
        execute: function () {
            ...
            function createTranslateLoader(http, version) {
                ...
                return new TranslateHttpLoader(http, BasePathService.convertPath('/apps/studentsystem/basicdata/web/bo-student-front/studentlist/i18n/'), '.json' + versionSuffix);
            }
            var lang = { "zh-CHS": { "root-component": "", "root-layout": "", "query-scheme-section": "", "Section/query-scheme-section/mainTitle": "主标题", "Section/query-scheme-section/subTitle": "", "query-scheme-1": "默认筛选方案", "QueryScheme/query-scheme-1/filterText": "筛选", "QueryScheme/query-scheme-1/f33c54bb-a7a0-4955-ba1b-416596150616": "学号", "QueryScheme/query-scheme-1/f33c54bb-a7a0-4955-ba1b-416596150616/placeHolder": "", "QueryScheme/query-scheme-1/0f343710-1600-4d5c-a34c-f8bcf813fe4f": "姓名", "QueryScheme/query-scheme-1/0f343710-1600-4d5c-a34c-f8bcf813fe4f/placeHolder": "", "QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564": "性别", "QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/placeHolder": "", "QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/control/enumValues/man": "男", "QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/control/enumValues/woman": "女", "page-header": "", "header-nav": "", "header-title-container": "", "page-header-title": "", "title": "学生列表", "page-header-toolbar": "", "button-add": "新增", "button-edit": "编辑", "button-view": "查看", "button-delete": "删除", "page-main": "", "data-grid-component-ref": "", "data-grid-component": "", "data-grid-section": "", "Section/data-grid-section/mainTitle": "", "Section/data-grid-section/subTitle": "", "dataGrid": "", "DataGrid/dataGrid/lineNumberTitle": "", "DataGrid/dataGrid/OperateEditButton": "编辑", "DataGrid/dataGrid/OperateDeleteButton": "删除", "DataGrid/dataGrid/OperateColumn": "操作", "stuID_f33c54bb_werk": "学号", "name_0f343710_2cpc": "姓名", "gender_0d948cbf_enne": "性别", "GridField/gender_0d948cbf_enne/enumData/man": "男", "GridField/gender_0d948cbf_enne/enumData/woman": "女" } };
            ...
            var RootViewmodel = /** @class */ (function (_super) {
                ...
                __decorate([
                    NgCommand({
                        name: 'Add1',
                        params: {
                            url: '7709a964-c3b3-412a-9784-503a54fd12bb',
            ...
            var PhoneNumber8ab0Entity = /** @class */ (function (_super) {
                __extends(PhoneNumber8ab0Entity, _super);
                ...
                PhoneNumber8ab0Entity = __decorate([
                    NgEntity({
                        originalCode: "Tel",
                        nodeCode: "tel"
                    })
            ...
            var StudentEntity = /** @class */ (function (_super) {
                ...
                __decorate([
                    ...
                    __metadata("design:type", PhoneNumber8ab0Entity)
            ...
            var StudentProxy = /** @class */ (function (_super) {
                ...
                function StudentProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/studentsystem/basicdata/v1.0/studentlist_frm';
            ...
            var StudentRepository = /** @class */ (function (_super) {
                ...
                StudentRepository = __decorate([
                    Injectable(),
                    NgRepository({
                        apiUrl: 'api/studentsystem/basicdata/v1.0/studentlist_frm',
            ...
            var RootComponent = /** @class */ (function (_super) {
                ...
                function RootComponent(wizardSer, keybindingService, langService, route, router, rootElement, localizationService, frmI18nSettingService, frameworkService, applicationParamsService, verifyService, stateMachine, sanitizer, injector) {
                    ...
                    _this.fieldConfigsqueryscheme1 = [
                        {
                            "id": "f33c54bb-a7a0-4955-ba1b-416596150616",
                            "labelCode": "StuID",
                            "code": "StuID",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/f33c54bb-a7a0-4955-ba1b-416596150616", _this.lang, "学号"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/f33c54bb-a7a0-4955-ba1b-416596150616/placeHolder", _this.lang, ""),
                            "control": { "id": "f33c54bb-a7a0-4955-ba1b-416596150616", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "0f343710-1600-4d5c-a34c-f8bcf813fe4f",
                            "labelCode": "Name",
                            "code": "Name",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/0f343710-1600-4d5c-a34c-f8bcf813fe4f", _this.lang, "姓名"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/0f343710-1600-4d5c-a34c-f8bcf813fe4f/placeHolder", _this.lang, ""),
                            "control": { "id": "0f343710-1600-4d5c-a34c-f8bcf813fe4f", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "0d948cbf-8228-4035-9561-58540494b564",
                            "labelCode": "Gender",
                            "code": "Gender",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564", _this.lang, "性别"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/placeHolder", _this.lang, ""),
                            "control": {
                                ...
                                "enumValues": [
                                    {
                                        "value": "man",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/control/enumValues/man", _this.lang, "男")
                                    },
                                    {
                                        "value": "woman",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/control/enumValues/woman", _this.lang, "女")
                                    }
                                ]
                            }
                        }
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "ff29fc70-fa3e-4d64-88aa-f74ddf99b3a0" },
                        ...
                        [
                            {
                                ...
                                field: 'stuID',
                                width: 120,
                                title: this.langService.transform("stuID_f33c54bb_werk", this.lang, "学号"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'name',
                                width: 120,
                                title: this.langService.transform("name_0f343710_2cpc", this.lang, "姓名"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'gender',
                                width: 120,
                                title: this.langService.transform("gender_0d948cbf_enne", this.lang, "性别"),
                                dataType: 'enum',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                                ...
                                formatter: {
                                    ...
                                    "options": {
                                        ...
                                        "data": [
                                            {
                                                "value": "man",
                                                "name": this.langService.transform("GridField/gender_0d948cbf_enne/enumData/man", this.lang, "男")
                                            },
                                            {
                                                "value": "woman",
                                                "name": this.langService.transform("GridField/gender_0d948cbf_enne/enumData/woman", this.lang, "女")
                                            }
                                        ]
                                    }
                                }
                ...
                StudentListModule = __decorate([
                    NgModule({
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/studentsystem/basicdata/web/bo-student-front/studentlist/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/studentsystem/basicdata/web/bo-student-front/studentlist/i18n/', '.json');
            }
            ...
            function View_RootComponent_3(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 5, "farris-querysolution", [["farris-querysolution-event-bind", ""], ["id", "query-scheme-1"]], [[8, "className", 0]], [[null, "queryEmitter"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("queryEmitter" === en)) {
                    ...
                    ad = (pd_1 && ad);
                } return ad; }, View_QuerySolutionComponent_0, RenderType_QuerySolutionComponent)), ɵprd(512, null, ConvertorService, ConvertorService, []), ɵprd(512, null, ɵa$1, ɵa$1, [HttpClient]), ɵprd(512, null, ɵb$2, ɵb$2, []), ɵdid(4, 770048, null, 0, QuerySolutionComponent, [NotifyService, ComponentFactoryResolver, Injector, BsModalService, ConvertorService, SolutionService, ɵa$1, ɵb$2, LocaleService], { fieldConfigs: [0, "fieldConfigs"], presetQuerySolutionName: [1, "presetQuerySolutionName"], presetFieldConfigs: [2, "presetFieldConfigs"], isDisabled: [3, "isDisabled"], formId: [4, "formId"], isFold: [5, "isFold"], isControlInline: [6, "isControlInline"], showCompleteLabel: [7, "showCompleteLabel"], enableInitQuery: [8, "enableInitQuery"], enableHistory: [9, "enableHistory"], filterText: [10, "filterText"] }, { queryEmitter: "queryEmitter" }), ɵdid(5, 16384, null, 0, FarrisQuerySolutionEventBindDirective, [Injector, QuerySolutionComponent, FrameContext], null, null)], function (_ck, _v) { var _co = _v.component; var currVal_1 = _co.fieldConfigsqueryscheme1; var currVal_2 = _co.QuerySolutionqueryscheme1; var currVal_3 = _co.presetFieldConfigsqueryscheme1; var currVal_4 = false; var currVal_5 = "StudentList"; var currVal_6 = !true; var currVal_7 = true; var currVal_8 = false; var currVal_9 = false; var currVal_10 = false; var currVal_11 = _co.filterTextqueryscheme1; _ck(_v, 4, 1, [currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10, currVal_11]); }, function (_ck, _v) { var currVal_0 = ɵnov(_v, 4).cls; _ck(_v, 0, 0, currVal_0); }); }
