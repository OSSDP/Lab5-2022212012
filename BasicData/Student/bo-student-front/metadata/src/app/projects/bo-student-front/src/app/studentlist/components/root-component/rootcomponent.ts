    ...
    fieldConfigsqueryscheme1 = [
        {
            ...
            "labelCode": "StuID",
            "code": "StuID",
            "name": this.langService.transform("QueryScheme/query-scheme-1/f33c54bb-a7a0-4955-ba1b-416596150616", this.lang, "学号"),
            "placeHolder": this.langService.transform("QueryScheme/query-scheme-1/f33c54bb-a7a0-4955-ba1b-416596150616/placeHolder", this.lang, ""),
        ...
        },
        {
            ...
            "labelCode": "Name",
            "code": "Name",
            "name": this.langService.transform("QueryScheme/query-scheme-1/0f343710-1600-4d5c-a34c-f8bcf813fe4f", this.lang, "姓名"),
            "placeHolder": this.langService.transform("QueryScheme/query-scheme-1/0f343710-1600-4d5c-a34c-f8bcf813fe4f/placeHolder", this.lang, ""),
        ...
        },
        {
            ...
            "labelCode": "Gender",
            "code": "Gender",
            "name": this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564", this.lang, "性别"),
            "placeHolder": this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/placeHolder", this.lang, ""),
            "control": {
                ...
                "enumValues": [
                    {
                        "value": "man",
                        "name": this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/control/enumValues/man", this.lang, "男")
                    },
                    {
                        "value": "woman",
                        "name": this.langService.transform("QueryScheme/query-scheme-1/0d948cbf-8228-4035-9561-58540494b564/control/enumValues/woman", this.lang, "女")
                    }]
            }
        }]
