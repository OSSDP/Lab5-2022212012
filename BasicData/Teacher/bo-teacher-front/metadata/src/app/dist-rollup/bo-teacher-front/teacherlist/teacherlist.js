/*! UPDATE TIME: 2024/11/11 01:22:12 */
    ...
    return {
        ...
        execute: function () {
            ...
            var RootViewmodel = /** @class */ (function (_super) {
                ...
                __decorate([
                    NgCommand({
                        name: 'Add1',
                        params: {
                            url: '736c857e-60d9-4f2b-8778-f504d4d31550',
            ...
            var PhoneNumber2b26Entity = /** @class */ (function (_super) {
                __extends(PhoneNumber2b26Entity, _super);
                ...
                PhoneNumber2b26Entity = __decorate([
                    NgEntity({
                        originalCode: "Tel",
                        nodeCode: "tel"
                    })
            ...
            var TeacherEntity = /** @class */ (function (_super) {
                ...
                __decorate([
                    ...
                    __metadata("design:type", PhoneNumber2b26Entity)
            ...
            var RootComponent = /** @class */ (function (_super) {
                ...
                function RootComponent(wizardSer, keybindingService, langService, route, router, rootElement, localizationService, frmI18nSettingService, frameworkService, applicationParamsService, verifyService, stateMachine, sanitizer, injector) {
                    ...
                    _this.fieldConfigsqueryscheme1 = [
                        {
                            "id": "57d810a3-ceec-4ae3-92e2-6f6049a7506c",
                            "labelCode": "TID",
                            "code": "TID",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/57d810a3-ceec-4ae3-92e2-6f6049a7506c", _this.lang, "工号"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/57d810a3-ceec-4ae3-92e2-6f6049a7506c/placeHolder", _this.lang, ""),
                            "control": { "id": "57d810a3-ceec-4ae3-92e2-6f6049a7506c", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "605611af-70c9-4efd-a948-696c3a907a57",
                            "labelCode": "Name",
                            "code": "Name",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/605611af-70c9-4efd-a948-696c3a907a57", _this.lang, "姓名"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/605611af-70c9-4efd-a948-696c3a907a57/placeHolder", _this.lang, ""),
                            "control": { "id": "605611af-70c9-4efd-a948-696c3a907a57", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "e200f3b4-3eb9-4d60-8820-9d0264a844f3",
                            "labelCode": "Gender",
                            "code": "Gender",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/e200f3b4-3eb9-4d60-8820-9d0264a844f3", _this.lang, "性别"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/e200f3b4-3eb9-4d60-8820-9d0264a844f3/placeHolder", _this.lang, ""),
                            "control": {
                                ...
                                "enumValues": [
                                    {
                                        "value": "man",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/e200f3b4-3eb9-4d60-8820-9d0264a844f3/control/enumValues/man", _this.lang, "男")
                                    },
                                    {
                                        "value": "woman",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/e200f3b4-3eb9-4d60-8820-9d0264a844f3/control/enumValues/woman", _this.lang, "女")
                                    }
                                ]
                            }
                        }
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "3efbc332-aff4-4950-9ab4-47e5c3ad4ad1" },
            ...
            var TeacherListRoutingModule = /** @class */ (function () {
                ...
                TeacherListRoutingModule = __decorate([
                    NgModule({
                        imports: [
                        ...
                        [
                            {
                                ...
                                field: 'tid',
                                width: 120,
                                title: this.langService.transform("tid_57d810a3_p081", this.lang, "工号"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'name',
                                width: 120,
                                title: this.langService.transform("name_605611af_jxcb", this.lang, "姓名"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'gender',
                                width: 120,
                                title: this.langService.transform("gender_e200f3b4_m7z7", this.lang, "性别"),
                                dataType: 'enum',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                                ...
                                formatter: {
                                    ...
                                    "options": {
                                        ...
                                        "data": [
                                            {
                                                "value": "man",
                                                "name": this.langService.transform("GridField/gender_e200f3b4_m7z7/enumData/man", this.lang, "男")
                                            },
                                            {
                                                "value": "woman",
                                                "name": this.langService.transform("GridField/gender_e200f3b4_m7z7/enumData/woman", this.lang, "女")
                                            }
                                        ]
                                    }
                                }
                            ...
                            {
                                id: 'tel_PhoneNumber_2b262162_6x3j',
                                field: 'tel.phoneNumber',
                                width: 120,
                                title: this.langService.transform("tel_PhoneNumber_2b262162_6x3j", this.lang, "联系方式"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
            ...
            var TeacherListModule = /** @class */ (function () {
                function TeacherListModule(trans) {
                    this.trans = trans;
                }
                TeacherListModule = __decorate([
                    NgModule({
                        exports: [
                            RootComponent
                        ],
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/studentsystem/basicdata/web/bo-teacher-front/teacherlist/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/studentsystem/basicdata/web/bo-teacher-front/teacherlist/i18n/', '.json');
            }
            ...
            function View_RootComponent_3(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 5, "farris-querysolution", [["farris-querysolution-event-bind", ""], ["id", "query-scheme-1"]], [[8, "className", 0]], [[null, "queryEmitter"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("queryEmitter" === en)) {
                    ...
                    ad = (pd_1 && ad);
                } return ad; }, View_QuerySolutionComponent_0, RenderType_QuerySolutionComponent)), ɵprd(512, null, ConvertorService, ConvertorService, []), ɵprd(512, null, ɵa$1, ɵa$1, [HttpClient]), ɵprd(512, null, ɵb$2, ɵb$2, []), ɵdid(4, 770048, null, 0, QuerySolutionComponent, [NotifyService, ComponentFactoryResolver, Injector, BsModalService, ConvertorService, SolutionService, ɵa$1, ɵb$2, LocaleService], { fieldConfigs: [0, "fieldConfigs"], presetQuerySolutionName: [1, "presetQuerySolutionName"], presetFieldConfigs: [2, "presetFieldConfigs"], isDisabled: [3, "isDisabled"], formId: [4, "formId"], isFold: [5, "isFold"], isControlInline: [6, "isControlInline"], showCompleteLabel: [7, "showCompleteLabel"], enableInitQuery: [8, "enableInitQuery"], enableHistory: [9, "enableHistory"], filterText: [10, "filterText"] }, { queryEmitter: "queryEmitter" }), ɵdid(5, 16384, null, 0, FarrisQuerySolutionEventBindDirective, [Injector, QuerySolutionComponent, FrameContext], null, null)], function (_ck, _v) { var _co = _v.component; var currVal_1 = _co.fieldConfigsqueryscheme1; var currVal_2 = _co.QuerySolutionqueryscheme1; var currVal_3 = _co.presetFieldConfigsqueryscheme1; var currVal_4 = false; var currVal_5 = "TeacherList"; var currVal_6 = !true; var currVal_7 = true; var currVal_8 = false; var currVal_9 = false; var currVal_10 = false; var currVal_11 = _co.filterTextqueryscheme1; _ck(_v, 4, 1, [currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10, currVal_11]); }, function (_ck, _v) { var currVal_0 = ɵnov(_v, 4).cls; _ck(_v, 0, 0, currVal_0); }); }
